...
> **Примітка:** Термінальний TUI (`mova tui`) **застарів** і буде видалений. Користуйтесь **веб-інтерфейсом** (`mova`) або **CLI** (`mova cli`).

## Можливості

- **Автоматичний переклад** — переклад JAR-модів через веб-інтерфейс або CLI
...
- **Пакетна обробка** — переклад окремих файлів, тек модів або вибір модів у веб-інтерфейсі
...
Відкриває браузерний майстер на `http://127.0.0.1:8000` (налаштування, вибір модів, прогрес, QA).
