...
def settings_to_config_dict(settings: Any, *, ui_locale: str | None = None) -> dict[str, Any]:
    ...
    data: dict[str, Any] = {
        ...
        "translation_path": settings.paths.translation_path,
        "mods_path": settings.paths.mods_path,
        "hint_lang": settings.hint_lang,
        "glossary_path": settings.glossary_path,
        "no_cache": settings.no_cache,
        "output_mode": settings.paths.output_mode,
        ...
        "qa_judge": settings.qa.enabled,
        "qa_judge_provider": settings.qa.provider,
        "qa_judge_model": settings.qa.model,
        "qa_corrector_model": settings.qa.corrector_model,
        "qa_threshold": settings.qa.threshold,
        "qa_max_attempts": settings.qa.max_attempts,
        "qa_chunk_size": settings.qa.chunk_size,
        "qa_judge_workers": settings.qa.judge_workers,
    }
